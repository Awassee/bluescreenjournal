# BlueScreen Journal Docs

BlueScreen Journal is a local-first encrypted terminal journal for macOS with a nostalgic blue-screen writing workflow.

- Latest stable: [v2.2.2](https://github.com/Awassee/bluescreenjournal/releases/tag/v2.2.2)
- Release notes: [v2.2.2](releases/v2.2.2.md)
- Current patch scope: [v2.2.3 follow-up plan](V2_2_3_PLAN.md)
- Prioritized backlog: [Next Priorities](NEXT_PRIORITIES.md)
- Long-term wake-up guide: [Maintenance Baseline](MAINTENANCE_BASELINE.md)
...
- [First 2 Minutes Cheat Sheet](CHEAT_SHEET.md)
- [Maintenance Baseline](MAINTENANCE_BASELINE.md)
...
![Editor](assets/bsj-editor.png)

![Search](assets/bsj-search.png)

![Calendar](assets/bsj-calendar.png)

![Index](assets/bsj-index.png)
